      (() => {
        ...
        if (waveBars) {
          ...
          const barCount = Math.max(20, Math.floor((waveBars.offsetWidth || 320) / (barW + barGap)));
        ...
        function haloLoop() {
          ...
          cx += dx * 0.12;
          cy += dy * 0.12;
          if (halo) halo.style.transform = "translate(calc(" + cx + "px - 50%), calc(" + cy + "px - 50%))";
        ...
        // ── Country picker ──
        const COUNTRIES = [
          {f:"🇱🇰",n:"Sri Lanka",d:"+94"},{f:"🇺🇸",n:"United States",d:"+1"},
          {f:"🇬🇧",n:"United Kingdom",d:"+44"},{f:"🇦🇺",n:"Australia",d:"+61"},
          {f:"🇨🇦",n:"Canada",d:"+1"},{f:"🇮🇳",n:"India",d:"+91"},
          {f:"🇸🇬",n:"Singapore",d:"+65"},{f:"🇦🇪",n:"UAE",d:"+971"},
          {f:"🇩🇪",n:"Germany",d:"+49"},{f:"🇫🇷",n:"France",d:"+33"},
          {f:"🇳🇱",n:"Netherlands",d:"+31"},{f:"🇯🇵",n:"Japan",d:"+81"},
          {f:"🇲🇾",n:"Malaysia",d:"+60"},{f:"🇮🇩",n:"Indonesia",d:"+62"},
          {f:"🇵🇭",n:"Philippines",d:"+63"},{f:"🇿🇦",n:"South Africa",d:"+27"},
          {f:"🇳🇬",n:"Nigeria",d:"+234"},{f:"🇧🇷",n:"Brazil",d:"+55"},
          {f:"🇲🇽",n:"Mexico",d:"+52"},{f:"🇳🇿",n:"New Zealand",d:"+64"},
          {f:"🇰🇷",n:"South Korea",d:"+82"},{f:"🇨🇳",n:"China",d:"+86"},
          {f:"🇵🇰",n:"Pakistan",d:"+92"},{f:"🇧🇩",n:"Bangladesh",d:"+880"},
          {f:"🇮🇹",n:"Italy",d:"+39"},{f:"🇪🇸",n:"Spain",d:"+34"},
          {f:"🇵🇹",n:"Portugal",d:"+351"},{f:"🇸🇪",n:"Sweden",d:"+46"},
          {f:"🇨🇭",n:"Switzerland",d:"+41"},{f:"🇹🇭",n:"Thailand",d:"+66"},
          {f:"🇻🇳",n:"Vietnam",d:"+84"},{f:"🇶🇦",n:"Qatar",d:"+974"},
          {f:"🇸🇦",n:"Saudi Arabia",d:"+966"},{f:"🇰🇪",n:"Kenya",d:"+254"},
          {f:"🇬🇭",n:"Ghana",d:"+233"},{f:"🇦🇷",n:"Argentina",d:"+54"},
          {f:"🇨🇴",n:"Colombia",d:"+57"},{f:"🇵🇪",n:"Peru",d:"+51"},
          {f:"🇮🇱",n:"Israel",d:"+972"},{f:"🇹🇷",n:"Turkey",d:"+90"},
        ];
        let selectedDial = "+94";
        ...
        function renderCountries(list) {
          ...
          list.forEach(c => {
            ...
            li.className = "country-item" + (c.d === selectedDial && c.n === (countryFlagEl?.title||"Sri Lanka") ? " ci-active" : "");
            ...
            li.addEventListener("click", () => {
              selectedDial = c.d;
              if (countryFlagEl) { countryFlagEl.textContent = c.f; countryFlagEl.title = c.n; }
              if (countryCodeLblEl) countryCodeLblEl.textContent = c.d;
              countrySelEl?.classList.remove("open");
              if (countryTriggerEl) countryTriggerEl.setAttribute("aria-expanded","false");
        ...
        if (countrySelEl) {
          ...
          countrySearchEl?.addEventListener("input", () => {
            ...
            renderCountries(q ? COUNTRIES.filter(c => c.n.toLowerCase().includes(q) || c.d.includes(q)) : COUNTRIES);
          });
          document.addEventListener("click", (e) => {
        ...
        phoneInputEl?.addEventListener("input", () => { if (phoneErrorEl?.classList.contains("show")) phoneErrorEl.classList.remove("show"); });
        ...
        function toggleTweaks(force) {
          const open =
            force !== undefined
              ? force
              : !tweaksPanel.classList.contains("open");
        ...
        const SYSTEM =
          "You are Kaizen AI's friendly assistant on the Kaizen AI website. Kaizen AI builds AI chatbots and voice agents that answer calls, handle customer enquiries, and book appointments 24/7/365 in 30+ languages. Pricing: Chatbot from $500/mo, Voice agent from $800/mo, Chat+Voice bundle from $1,500/mo — plus a one-time setup fee. Setup takes 3–5 days for chatbots, 7–14 days for voice agents. Keep replies concise (2–4 short sentences), warm, and helpful. If the visitor wants to book a call, tell them to click 'Book a call' at the top of the page or in the CTA section. Never invent features not listed. If asked unrelated things, gently steer back to how Kaizen AI could help their business.";
